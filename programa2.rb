...
# creamos un hash con dos claves nombre= string y teléfono = array
# añadimos el nombre con el metodo ask
# añadimos el teléfono y preguntamos si quiere añadir otro
# vamos a meter un loop para ver si tiene más teléfonos y si quiere añadir
